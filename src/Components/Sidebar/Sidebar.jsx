    ...
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
        <div className="shortcutlinks">
            ...
            <div className={`sidelinks ${category===2?"active":""}`} onClick={()=>setCategory(2)}>
                <img src={automobiles}  alt="" /><p>Automotive</p>
            </div>
        ...
        <div className="subscribedlist">
            ...
            <div className="sidelinks">
                <img src={simon} alt =""/><p>IshowSpeed</p>
            </div>
            <div className="sidelinks">
                <img src={tom} alt =""/><p>Mr.Beast</p>
            </div>
            <div className="sidelinks">
                <img src={megan} alt =""/><p>NikocadoAvocado</p>
            </div>
            <div className="sidelinks">
                <img src={cameron} alt =""/><p>Buret</p>
            </div>
        </div>
